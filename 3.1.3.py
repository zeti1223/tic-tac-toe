...
class TicTacToe:
    ...
    def start(self):
        ...
        print("3. Player vs Medium Bot")
        print("4. Player vs Hard Bot")
        ...
        self.current_player = self.get_random_first_player()
        self.bot_player = 'O' if self.current_player == 'X' else 'X'
        game_over = False
        ...
        while not game_over:
            ...
            if self.current_player == 'X':
                ...
                try:
                    ...
                    self.fix_spot(row - 1, col - 1, self.current_player)
                ...
                print(f'Bot {self.current_player} turn')
                self.easy_bot_move()

            game_over = self.has_player_won(self.current_player)
            if game_over:
                self.show_board()
    ...
    def player_vs_medium_bot(self):
        game_over = False

        if self.current_player == 'O':
            self.medium_bot_move()
            self.current_player = 'X'
